...
const checkAccessByEnum = (role:UserRoleEnum) => {
    ...
    if(role === UserRoleEnum.Editor) return 'Limited Access'
...
(typeof UserRoleAsCons1)[keyof typeof UserRoleAsConst1] = 'ADMIN' | 'EDITOR' | 'VIEWER'
*/

const checkAccessByAsConst1 = (role: (typeof UserRoleASConst1) [keyof typeof UserRoleASConst1]) => {
    if(role === UserRoleASConst1.Admin) return 'Full Access Granted!';
    if(role === UserRoleASConst1.Editor) return 'Limited Access'
